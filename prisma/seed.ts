...
const attributes = [
  { name: 'service', showToUser: true },
  { name: 'printing', showToUser: true },
  { name: 'dieShape', showToUser: true },
  { name: 'textureType', showToUser: true },
  { name: 'paperQuality', showToUser: true },
  { name: 'colour', showToUser: true },
  { name: 'paperQuanlity', showToUser: true },
  { name: 'pocket', showToUser: true },
  { name: 'binding', showToUser: true },
  { name: 'envelopeCode', showToUser: true },
  { name: 'flapOpening', showToUser: true },
  { name: 'windowCutting', showToUser: true },
  { name: 'paperType', showToUser: true },
  { name: 'size', showToUser: true },
  { name: 'lamination', showToUser: true },
  { name: 'halfCut', showToUser: true },
  { name: 'firstPaperQuality', showToUser: true },
  { name: 'secondCopyPaperColor', showToUser: true },
  { name: 'thirdCopyPaperColor', showToUser: true },
  { name: 'stickersCountPerSheet', showToUser: true },
  { name: 'OpenType', showToUser: true },
];
const capabilities = [
  { name: "View Users" },
  { name: "Add User" },
